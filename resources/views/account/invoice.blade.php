                        ...
                        <div class="mt-4">
                            ...
                            @php
                                ...
                                $order_products = DB::table('orders_products')
                                    ->join('products', 'orders_products.order_products_product_id', '=', 'products.id')
                                    ->where('orders_products.orders_id', $order_id)
                                    ->select('orders_products.*', 'products.price') // Select the necessary columns, including the price from the products table
                                    ->get();
                            ...
                            <div class="text-95 text-secondary-d3">
                                ...
                                @foreach ($order_products as $order_product)
                                    <div class="row mb-2 mb-sm-0 py-25 text-white">
                                        ...
                                        <div class="d-none d-sm-block col-2 text-95">
                                            ${{ $order_product->price }}</div>

                                        <div class="col-2 text-secondary-d2">${{ $order_product->order_products_qty *  $order_product->price }}.00
                                        </div>
