            ...
            <div class="col-lg-6 col-md-8 col-12">
                <div class="gg-auth-card">
                    <div class="gg-auth-header">
                        ...
                        <p>Join GadgetGrove for exclusive mobile accessories deals</p>
                    </div>
                    ...
                    <form class="gg-auth-form" id="order-place" method="POST" action="{{ route('register') }}">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="gg-form-group">
                                    <label><i class="fa-solid fa-user mr-2"></i>First Name</label>
                                    <input type="text" name="fname" class="gg-form-control" value="{{ old('fname') }}" placeholder="John" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="gg-form-group">
                                    <label><i class="fa-solid fa-user mr-2"></i>Last Name</label>
                                    <input type="text" name="lname" class="gg-form-control" value="{{ old('lname') }}" placeholder="Doe" required>
                                </div>
                            </div>
                        </div>
                        <div class="gg-form-group">
                            <label><i class="fa-regular fa-envelope mr-2"></i>Email Address</label>
                            <input type="email" name="email" class="gg-form-control" value="{{ old('email') }}" placeholder="you@example.com" required>
                        </div>
                        <div class="gg-form-group">
                            <label><i class="fa-solid fa-lock mr-2"></i>Password</label>
                            <input type="password" name="password" class="gg-form-control" placeholder="Min. 6 characters" required>
                        </div>
                        <div class="gg-form-group">
                            <label><i class="fa-solid fa-lock mr-2"></i>Confirm Password</label>
                            <input type="password" name="password_confirmation" class="gg-form-control" placeholder="Repeat your password" required>
                        </div>
