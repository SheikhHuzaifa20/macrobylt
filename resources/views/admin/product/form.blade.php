<div class="form-body">
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="form-group">
                <label for="value">Freature Product:</label>
                <select class="form-control" id="value" name="feature_product">
        ...
        <div class="col-md-12">
            <div class="form-group">
                {!! Form::label('section_2_h1', 'Heading 2') !!}
                {!! Form::text(
                    'section_2_h1',
                    null,
                    'required' == 'required' ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control'],
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <input class="form-control dropify" name="image_2" type="file" id="image_2"
                    {{ $product->image_2 != '' ? "data-default-file = /$product->image_2" : '' }}
                    {{ $product->image_2 == '' ? 'required' : '' }} value="{{ $product->image_2 }}">
            </div>
        </div>
        <div class="col-md-12">
            <div class="form-group">
                {!! Form::label('section_2_p', 'Description 2') !!}
                {!! Form::textarea(
                    'section_2_p',
                    null,
                    'required' == 'required'
