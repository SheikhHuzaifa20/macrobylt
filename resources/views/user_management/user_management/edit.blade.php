        ...
        <div class="row breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Edit User_two #{{ $user_two->id }}</li>
                </ol>
            </div>
        </div>
    </div>
              ...
              <div class="card">
                  ...
                  <div class="card-content collapse show">
                      <div class="card-body">
                        {!! Form::model($user_two, [
                            'method' => 'PATCH',
                            'url' => ['/user_managements/user_managements', $user_two->id],
                            'files' => true
                        ]) !!}

                        @include ('user_management.user_management.form', ['submitButtonText' => 'Update'])
